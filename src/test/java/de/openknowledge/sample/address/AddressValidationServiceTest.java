...
public class AddressValidationServiceTest {
    ...
    @TestTarget
    public final Target target = new HttpTarget("http", "localhost", Integer.valueOf(System.getProperty("test.http.port", "6003")), "/address-validation");
    @ArquillianResource
    private URI uri;
    ...
    public static WebArchive createDeployment() throws Exception {
        ...
        return ShrinkWrap.create(WebArchive.class, "address-validation.war")
